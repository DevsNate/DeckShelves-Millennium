...
export function createGlobalVisualActions(deps: GlobalVisualDeps) {
  ...
  return {
    ...
    setScaleMiniCarouselSpacing: (v: boolean) => setBool("scaleMiniCarouselSpacing", v),
    setMatchNativeShelfTitleOpacity: (v: boolean) => setBool("matchNativeShelfTitleOpacity", v),
    setAutoHideShelfTitles: (v: boolean) => setBool("autoHideShelfTitles", v),
