...
export function VisualGlobalSection({ controller, hidden, isHid, lightMode, mountCrashed, hasNonSteamBadges }: {
  ...
  return (
      ...
      >
        ...
        {!isHid('scaleMiniCarouselSpacing') && <ToggleField label={t('scale_mini_carousel_spacing' as any)} checked={settings.scaleMiniCarouselSpacing === true} disabled={mountCrashed} onChange={(value: boolean) => actions.setScaleMiniCarouselSpacing(value)} />}
        {!isHid('matchNativeShelfTitleOpacity') && <ToggleField label={t('match_native_shelf_title_opacity' as any)} checked={settings.matchNativeShelfTitleOpacity === true} disabled={mountCrashed} onChange={(value: boolean) => actions.setMatchNativeShelfTitleOpacity(value)} />}
        {!isHid('autoHideShelfTitles') && <ToggleField label={t('auto_hide_shelf_titles' as any)} checked={settings.autoHideShelfTitles === true} disabled={mountCrashed} onChange={(value: boolean) => actions.setAutoHideShelfTitles(value)} />}
        ...
        {!isHid('keepShelvesStacked') && <ToggleField label={t('keep_shelves_stacked_label' as any)} checked={settings.keepShelvesStacked !== false} disabled={mountCrashed} onChange={(value: boolean) => void actions.setKeepShelvesStacked(value)} />}
        {!isHid('fadeRecentsTitle') && <ToggleField label={t('fade_recents_title' as any)} checked={settings.fadeRecentsTitle === true} disabled={mountCrashed} onChange={(value: boolean) => void actions.setFadeRecentsTitle(value)} />}
