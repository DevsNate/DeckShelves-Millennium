...
def _sanitize_settings_base(settings: Dict[str, Any]) -> Dict[str, Any]:  # noqa: C901
    ...
    for s in shelves:
        ...
        # Missing/true means keep the compatibility default. Persist only the
        # explicit opt-in that allows Art Hero to theme this shelf.
